    ...
    def __init__(
        ...
        self.add_item(
            discord.ui.TextDisplay(
                ...
                f"> O **Staff** {author.mention} **trancou** o canal {channel.mention}.\n"
                f"- Motivo: **{reason}**"
            )
        )
...
class Lock(commands.GroupCog, name="trancar"):
    ...
    @app_commands.describe(
        canal="Canal a ser trancado.",
        motivo="Motivo do trancamento."
    )
    ...
    async def lock(
        ...
        try:
            ...
            await interaction.response.send_message(
                view=ErrorMessage(
                    "Não tenho permissão para trancar este canal."
                ),
                ephemeral=True
            )
            ...
            await interaction.response.send_message(
                view=ErrorMessage(
                    "Ocorreu um erro ao trancar o canal.\n- Erro: `{e}`"
                ),
                ephemeral=True
            )
